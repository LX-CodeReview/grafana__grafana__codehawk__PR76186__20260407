...
require (
	...
	github.com/prometheus/common v0.67.4 // @grafana/alerting-squad-backend
...
require (
	...
	go.opentelemetry.io/contrib/propagators/jaeger v1.39.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.39.0 // @grafana/backend-platform
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.39.0 // @grafana/backend-platform
...
require (
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.33.0 // @grafana/backend-platform
